...
@api_router.get("/clinic/expenses/dashboard")
...
@api_router.get("/clinic/expenses/by-category")
...
@api_router.get("/clinic/expenses/by-supplier")
...
@api_router.get("/clinic/expenses")
...
@api_router.post("/clinic/expenses")
...
@api_router.put("/clinic/expenses/{expense_id}")
...
@api_router.delete("/clinic/expenses/{expense_id}")
...
@api_router.post("/clinic/expenses/{expense_id}/attachment")
...
@api_router.get("/clinic/expenses/{expense_id}/attachment-url")
...
@api_router.get("/clinic/commissions/settings")
...
@api_router.post("/clinic/commissions/settings")
...
@api_router.put("/clinic/commissions/settings/{rule_id}")
...
@api_router.delete("/clinic/commissions/settings/{rule_id}")
...
@api_router.get("/clinic/commissions/earned")
...
@api_router.get("/clinic/commissions/dashboard")
...
@api_router.post("/clinic/commissions/pay")
...
# --- PDF Report ---
@api_router.get("/clinic/commissions/report-pdf")
...
@api_router.get("/clinic/reports/executive-summary")
...
@api_router.get("/clinic/reports/income")
...
@api_router.get("/clinic/reports/pnl")
...
@api_router.get("/clinic/reports/inventory")
...
@api_router.get("/clinic/reports/by-branch")
...
@api_router.get("/clinic/reports/pnl-pdf")
async def pnl_pdf(
    period: str = "current_month", date_from: str = "", date_to: str = "",
    branch_id: str = "", ctx=Depends(require_clinic_member)
):
