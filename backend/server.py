...
# Imported here (after all shared symbols are defined) so that routes can do
# `from server import sdb, ...` without circular-import errors.
from routes import inventory as _r_inv, expenses as _r_exp, commissions as _r_comm, sales as _r_sales, accounts_receivable as _r_ar, reports as _r_rep
for _r in (_r_inv, _r_exp, _r_comm, _r_sales, _r_ar, _r_rep):
